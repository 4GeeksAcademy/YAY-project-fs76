...
Revision ID: cf2416f83663
Revises: 
Create Date: 2024-10-11 22:53:31.808927
...
def upgrade():
    ...
    sa.Column('intereses_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['intereses_id'], ['intereses.id'], ),
