                        ...
                        <div className="row position-relative zi-2 mt-md-n5">
                            <div className="col-md-8 mb-7 mb-md-0" style={{
                                ...
                                <div className="d-flex gap-3">
                                    <button className="btn btn-lg btn-transition" style={{ backgroundColor: '#A7D0CD', color: '#494949' }}>Regístrate en YAY</button>
                                    <a className="btn btn-link" href="#" style={{ color: '#A7D0CD', fontSize: '25px' }}> Saber más<i className="fa-solid fa-chevron-right small ms-1"></i></a>
                                </div>
                            ...
                            <div className="col-md-6 position-md-absolute top-0 end-0">
                                <img
                                    className="img-fluid"
                                    src="https://htmlstream.com/preview/front-v4.3.1/assets/img/900x900/img20.jpg"
