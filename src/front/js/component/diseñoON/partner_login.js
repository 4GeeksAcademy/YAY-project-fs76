                    ...
                    <form className="js-validate needs-validation" noValidate onSubmit={sendData} ref={formRef} onKeyDown={handleKeyDown}>
                      ...
                      <div className="mb-3">
                        <div className="d-flex justify-content-between align-items-center">
                          ...
                          <a className="form-label-link" href="./forgot-password">¿Olvidaste tu contraseña?</a>
                        </div>
                      ...
                      <div className="text-center">
                        <h5>¿Es tu primera en YAY? <Link to="/partners-signup" style={{ color: '#de8f79' }}>Regístrate como Partner</Link></h5>
                      </div>
                    </form>
                  </div>
                </div>
