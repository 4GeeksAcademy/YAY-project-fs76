...
export const Navbar = () => {
    ...
    const isSignin = location.pathname === "/login" || location.pathname === "/signup" || location.pathname === "/partners-login" || location.pathname === "/partners-forgot-password" ;
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light w-100" style={{ zIndex: '2' }}>
