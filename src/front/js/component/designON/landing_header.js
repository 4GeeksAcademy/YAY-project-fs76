                        ...
                        <div className="row position-relative zi-2 mt-md-n5">
                            <div className="col-md-8 mb-7 mb-md-0" style={{
                                ...
                                <div className="w-md-75 mb-7" >
                                    <h1 className="display-4 title-header">
                                ...
                                <div className="d-flex gap-3">
                                    <Link to="/signup">
                                    <button className="btn btn-lg btn-transition registraYay" style={{ backgroundColor: '#7c488f', color: 'white' }}>Regístrate en YAY</button>
                                    </Link>
                                    <a className="btn btn-link saberMas" href="/sobre-nosotros" style={{ color: '#7c488f', fontSize: '25px' }}> Saber más<i className="fa-solid fa-chevron-right small ms-1"></i></a>
                                </div>
