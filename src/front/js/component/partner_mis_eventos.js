            ...
            {loading ? (
                ...
                <ul className="list-group">
                    {Array.isArray(store.eventos) && store.eventos
                        ...
                        .map((evento) => (
                            <li key={evento.id} className="list-group-item d-flex justify-content-between p-0" style={{ boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', border: 'none', marginBottom: '10px' }}>
                                <div className="d-flex justify-content-between flex-grow-1">
                                    ...
                                    <ul className="ms-5 flex-grow-1" style={{ listStyle: 'none', padding: 0 }}>
                                        ...
                                        <li className="text-muted fs-7" style={{ maxWidth:'300px'}}>
